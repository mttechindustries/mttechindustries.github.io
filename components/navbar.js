      ...
      <nav class="fixed top-0 left-0 right-0 z-50 border-b border-slate-800/80 bg-slate-950/90 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div class="hidden items-center gap-7 text-sm text-slate-400 md:flex">
            <a href="${base}index.html#commercialization" class="transition hover:text-cyan-400">Commercialization</a>
            <a href="${base}index.html#patents" class="transition hover:text-cyan-400">Filed IP</a>
            <a href="${base}licensing.html" class="transition hover:text-cyan-400">Pilot &amp; Licensing</a>
            <a href="${base}investors.html" class="transition hover:text-amber-400">Company</a>
            <a href="${base}sponsor.html" class="font-semibold text-emerald-300 transition hover:text-emerald-200">Support</a>
          </div>

          <div class="flex items-center gap-3">
            <a href="${base}nda_form.html" class="rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-2 text-xs font-semibold text-slate-950 shadow-lg shadow-cyan-500/20 transition hover:brightness-110 sm:text-sm">Protected Review</a>
            <button id="mt-mobile-toggle" class="rounded-lg border border-slate-700 p-2 text-slate-300 transition hover:text-cyan-400 md:hidden">
        ...
        <div id="mt-mobile-menu" class="hidden border-t border-slate-800 bg-slate-950/95 md:hidden">
          <div class="flex flex-col gap-1 px-6 py-4 text-sm text-slate-400">
            <a href="${base}index.html#commercialization" class="py-2 transition hover:text-cyan-400">Commercialization</a>
            <a href="${base}index.html#patents" class="py-2 transition hover:text-cyan-400">Filed IP</a>
            <a href="${base}licensing.html" class="py-2 transition hover:text-cyan-400">Pilot &amp; Licensing</a>
            <a href="${base}investors.html" class="py-2 transition hover:text-amber-400">Company</a>
            <a href="${base}sponsor.html" class="py-2 font-semibold text-emerald-300 transition hover:text-emerald-200">Support</a>
            <a href="${base}nda_form.html" class="mt-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-2 text-center font-semibold text-slate-950">Protected Review</a>
          </div>
        </div>
      </nav>
    `;
