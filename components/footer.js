        ...
        <div class="container mx-auto px-6">
          <div class="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul class="space-y-2">
                ...
                <li><a href="/projects/pre-physical.html" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">PAFFT Omnimath</a></li>
                ...
                <li><a href="/projects/platform.html" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">MK2 Platform</a></li>
            ...
            <div>
              ...
              <ul class="space-y-2">
                <li><a href="https://github.com/mttechindustries" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Research Repositories</a></li>
                <li><a href="/authentication-system.md" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Technical Notes</a></li>
                <li><a href="/public-repo-management.md" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Public Repo Management</a></li>
                <li><a href="/digest.txt" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Digest</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="space-y-2">
                ...
                <li><a href="mailto:info@mttechindustries.com?subject=Careers%20Inquiry" class="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Careers</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex gap-6">
              <a href="https://github.com/mttechindustries" class="text-slate-500 hover:text-cyan-400 transition-colors" aria-label="GitHub">
                <i data-feather="github" class="w-5 h-5"></i>
              </a>
              <a href="mailto:info@mttechindustries.com" class="text-slate-500 hover:text-cyan-400 transition-colors" aria-label="LinkedIn contact">
                <i data-feather="linkedin" class="w-5 h-5"></i>
              </a>
              <a href="mailto:info@mttechindustries.com" class="text-slate-500 hover:text-cyan-400 transition-colors" aria-label="X contact">
          ...
          <div class="text-slate-500 text-xs text-center mt-4 pt-4 border-t border-slate-800">
            ...
            <div class="mt-2 flex justify-center gap-4">
              ...
              <a href="/nda_form.html" class="text-slate-500 hover:text-cyan-400 text-xs">Secure Access</a>
            </div>
          </div>
        </div>
      </footer>
